...
If you remove or change the label of the node which the pod is running on,the running pod won't be stopped.It means tha the affinity selection only works when the pod was scheduled. 
